  ...
  const content = {
    fr: {
      ...
      sections: [
        ...
        { heading: "3. Réservations et paiements", body: "Toute réservation effectuée via PCV constitue un contrat de service entre le client et le prestataire. Le paiement s'effectue exclusivement en ligne via les méthodes proposées (Airtel Money, Orange Money, carte bancaire, PayPal). Aucun paiement en espèces n'est accepté. PCV prélève une commission de 15% sur chaque transaction." },
        ...
        { heading: "8. Droit applicable", body: "Les présentes conditions sont régies par le droit congolais. Tout litige sera soumis à la juridiction compétente de Brazzaville, République du Congo." },
      ],
    },
    en: {
      title: "Terms of Use",
      ...
      sections: [
        ...
        { heading: "3. Bookings and payments", body: "Any booking made via PCV constitutes a service contract between the client and the cleaner. Payment is made exclusively online via the methods offered (Airtel Money, Orange Money, card, PayPal). No cash payments are accepted. PCV charges a 15% commission on each transaction." },
        ...
        { heading: "8. Governing law", body: "These terms are governed by Congolese law. Any dispute will be submitted to the competent jurisdiction of Brazzaville, Republic of Congo." },
      ],
    },
    es: {
      ...
      sections: [
        ...
        { heading: "8. Derecho aplicable", body: "Estas condiciones se rigen por el derecho congoleño. Cualquier litigio se someterá a la jurisdicción competente de Brazzaville, República del Congo." },
      ],
    },
  }[lang];
